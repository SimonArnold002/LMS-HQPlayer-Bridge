...
tree, runs the five Perl suites (863 assertions at 1.0.13 + round 20) and the
helper's Python suite (79), checks `install.sh` parses, and sweeps
called-vs-defined subs. Counts move every round; the run prints them.
